...
class Mandrill {
    ...
    public function sslVerifyHost($check = 2){
		curl_setopt($this->ch, CURLOPT_SSL_VERIFYHOST, $check);
		
		return $this;
	}

	
	public function sslVerifyPeer($check = 1){
		curl_setopt($this->ch, CURLOPT_SSL_VERIFYPEER, $check);
